 ...
 */
export declare type BodyMethod = "arrayBuffer" | "blob" | "formData" | "json" | "text";
/**
 ...
 */
export declare type LoadedValue = BodyResolveValue | HTMLImageElement | HTMLVideoElement | HTMLAudioElement | LoadedXMLValue;
/**
